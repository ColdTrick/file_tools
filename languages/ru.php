...
return array(
	...
	'file_tools:show_more' => 'Показать больше файлов',
	...
	// upload
	'file_tools:upload:tabs:single' => "Один файл",
	'file_tools:upload:tabs:multi' => "Несколько файлов",
	'file_tools:upload:tabs:zip' => "Zip файл",
	'file_tools:upload:form:choose' => 'Выберите файл',
	'file_tools:upload:form:info' => 'Нажмите просмотр для загрузки нескольких файлов',
	'file_tools:upload:form:zip:info' => "Вы можете загрузить zip файл. После загрузки он будет распакован и каждый файл будет по отдельности создан. Также если у вас есть директории в архиве то они будут загружены в соответсвующую директорию. Неразрешенные типы файлов будут пропущены.",
	...
	'file_tools:settings:list_length' => 'Сколько файлов показывать в списке',
	'file_tools:settings:list_length:unlimited' => 'Неограничено',
